...
API Information : 
  This project uses TheCocktailDB API, which provides data about drinks including name, category, alcoholic type, image, ingredients, and preparation instructions.
